...
#+ (axis=3, center=True, scale=True,beta_initializer="random_uniform",gamma_initializer="random_uniform")(x)
...
def convolution_block(x, filters, size, strides=(1,1), padding='same', activation=True):
    ...
    x = tf.keras.layers.BatchNormalization(axis=3, center=True, scale=True,
...
def residual_block(blockInput, num_filters=16):
 ...
 #ResNet101V2 + UNet
def ResUNet101V2(input_shape=(None, None, 3), dropout_rate=0.1, start_neurons = 16, weights='imagenet'):
